  ...
  <div class="container"> 
      ...
      <div class="content">
      	  <div class="cinema-details">
      	  	  <p class="movie-info">{{ cinemaName }}</p>
      	  </div>
      	  <div class="movie-details">
      	      <p class="movie-info">{{ day }} {{ date }} {{ showTime }} {{ hallType }}</p>
      	  </div>
      	  <div class="seat-details">
      	  	  <div id="seat-map"></div>
      	  	  <div id="legend"></div>
          	  <div class="supplier-info"><span class="supplier-detail">服务来自{{ supplier }}</span></div>
          </div>
	      <div class="booking-details">
	      	  <div class="selected-seats-info">
	      	  	  <ul id="selected-seats"></ul>
	      	  </div>
	      	  <div class="selected-seats-warn">
	      	  	  <span>尚未选座，您最多可选四个座位</span>
	      	  </div>
	      </div>
...
export default {
  ...
  ready () {
    ...
    var sc = $('#seat-map').seatCharts({ 
        ...
        click: function () { //点击事件 
            if (this.status() == 'available') {  
            	if (sc.find('selected').length < 4) { //可选座
...
<style>
@import '../../node_modules/vue-toast/dist/vue-toast.min.css';

.movie-info {position: absolute;display: block;width: 100%;padding: 0;margin: 0 -.5rem;font-size: .85rem;font-weight: 500;line-height: 1.8rem;color: #3d4145;text-align: center;white-space: nowrap;}
.cinema-details {width: 100%;height: 7%;background-color: #f7f7f8;display: block;}
.movie-details {width: 100%;height: 7%;background-color: #f7f7f8;display: block;}
.seat-details {width: 100%;height: 70%;margin-left: auto;margin-right: auto;display: block;overflow: scroll;}
.booking-details {width:100%;height: 7%; background-color: #f7f7f8; border-bottom: 1px solid #eee;} 
.booking-details p{line-height:26px; font-size:16px; color:#999} 
.booking-details p span{color:#666}
.selected-seats-info {width: 100%;text-align: left;margin-left: auto;margin-right: auto;} 
...
div.seatCharts-container {width: 100%;margin-left: auto;margin-right: auto;} 
ul.seatCharts-legendList {list-style: none;position: relative;left: 45%;float: left;} 
ul.seatCharts-legendList li {position: relative;right: 50%;float: left;}
.seatCharts-legendItem{float:left; width:90px;line-height: 2;margin-left: auto;margin-right: auto;} 
...
.total-payment {width: 65%;height: 100%;float: left;margin-left: 2%;margin-top: 2%;color: #feae1b;}
.confirm-order {width: 30%;height: 100%;float: right;}
</style>